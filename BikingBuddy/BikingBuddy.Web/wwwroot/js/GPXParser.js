 ...
 * 
 * @param {HTMLElement} gpxstring - A GPX formatted String
 * 
...
gpxParser.prototype.calculDistance = function(points) {
    ...
    for (var i = 0; i < points.length - 1; i++) {
        ...
        cumulDistance[i] = totalDistance.toFixed(2);
        elevation[i] = points[i].ele;
    }
    cumulDistance[points.length - 1] = totalDistance;

    distance.total = totalDistance.toFixed(2);
    distance.cumul = cumulDistance;
    distance.elePoints= elevation;
