namespace BikingBuddy.Data.Models
{
    ...
    public class Event
    {
        ...
        [Required] [MaxLength(TitleMaxLength)] public string Title { get; set; } = null!;
        ...
        [Required] public double Ascent { get; set; }
        ...
        [ForeignKey(nameof(ActivityTypeId))] public virtual ActivityType ActivityType { get; set; } = null!;
